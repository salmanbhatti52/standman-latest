...
//
//     final cancelJobModels = cancelJobModelsFromJson(jsonString);

import 'dart:convert';

CancelJobModels cancelJobModelsFromJson(String str) =>
    CancelJobModels.fromJson(json.decode(str));

String cancelJobModelsToJson(CancelJobModels data) =>
    json.encode(data.toJson());

class CancelJobModels {
  String? status;
  String? message;
  Data? data;
  ...
  factory CancelJobModels.fromJson(Map<String, dynamic> json) =>
      CancelJobModels(
        status: json["status"],
