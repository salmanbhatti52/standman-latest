...
//
//     final acceptedJobsList = acceptedJobsListFromJson(jsonString);

import 'dart:convert';

AcceptedJobsList acceptedJobsListFromJson(String str) =>
    AcceptedJobsList.fromJson(json.decode(str));

String acceptedJobsListToJson(AcceptedJobsList data) =>
    json.encode(data.toJson());

class AcceptedJobsList {
  String? status;
  List<Datum>? data;
  ...
  factory AcceptedJobsList.fromJson(Map<String, dynamic> json) =>
      AcceptedJobsList(
        status: json["status"],
        data: json["data"] != null
...
class Jobs {
  ...
  factory Jobs.fromJson(Map<String, dynamic> json) => Jobs(
        ...
        specialInstructions: json["special_instructions"] ?? "Description",
        price: json["price"],
