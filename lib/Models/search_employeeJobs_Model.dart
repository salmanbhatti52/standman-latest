...
//
//     final searchEmployeeJobsModel = searchEmployeeJobsModelFromJson(jsonString);

import 'dart:convert';

SearchEmployeeJobsModel searchEmployeeJobsModelFromJson(String str) => SearchEmployeeJobsModel.fromJson(json.decode(str));

String searchEmployeeJobsModelToJson(SearchEmployeeJobsModel data) => json.encode(data.toJson());

class SearchEmployeeJobsModel {
  String? status;
  List<Datum>? data;
  ...
  factory SearchEmployeeJobsModel.fromJson(Map<String, dynamic> json) => SearchEmployeeJobsModel(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    usersCustomersData: Data.fromJson(json["users_customers_data"]),
    employeeData: Data.fromJson(json["employee_data"]),
  );
