...
GetPreviousJobsEmployeeModel getPreviousJobsEmployeeModelFromJson(String str) =>
    GetPreviousJobsEmployeeModel.fromJson(json.decode(str));

String getPreviousJobsEmployeeModelToJson(GetPreviousJobsEmployeeModel data) =>
...
class GetPreviousJobsEmployeeModel {
  ...
  factory GetPreviousJobsEmployeeModel.fromJson(Map<String, dynamic> json) =>
      GetPreviousJobsEmployeeModel(
        status: json["status"],
        data: json["data"] != null
