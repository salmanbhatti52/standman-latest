...
//
//     final editJobWalletOrStripe = editJobWalletOrStripeFromJson(jsonString);

import 'dart:convert';

EditJobWalletOrStripe editJobWalletOrStripeFromJson(String str) =>
    EditJobWalletOrStripe.fromJson(json.decode(str));

String editJobWalletOrStripeToJson(EditJobWalletOrStripe data) =>
    json.encode(data.toJson());

class EditJobWalletOrStripe {
  String? status;
  String? message;
  Data? data;

  EditJobWalletOrStripe({
    this.status,
    this.message,
    this.data,
  });

  factory EditJobWalletOrStripe.fromJson(Map<String, dynamic> json) =>
      EditJobWalletOrStripe(
        status: json["status"],
