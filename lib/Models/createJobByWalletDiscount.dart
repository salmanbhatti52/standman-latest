...
//
//     final createJobByWalletDiscount = createJobByWalletDiscountFromJson(jsonString);

import 'dart:convert';

CreateJobByWalletDiscount createJobByWalletDiscountFromJson(String str) =>
    CreateJobByWalletDiscount.fromJson(json.decode(str));

String createJobByWalletDiscountToJson(CreateJobByWalletDiscount data) =>
    json.encode(data.toJson());

class CreateJobByWalletDiscount {
  String? status;
  Data? data;
  ...
  factory CreateJobByWalletDiscount.fromJson(Map<String, dynamic> json) =>
      CreateJobByWalletDiscount(
        status: json["status"],
