...
AddJobRatingModel addJobRatingModelFromJson(String str) =>
    AddJobRatingModel.fromJson(json.decode(str));

String addJobRatingModelToJson(AddJobRatingModel data) =>
...
class AddJobRatingModel {
  ...
  factory AddJobRatingModel.fromJson(Map<String, dynamic> json) =>
      AddJobRatingModel(
        status: json["status"],
