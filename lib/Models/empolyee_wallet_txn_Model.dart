...
EmployeewalletTxnModel employeewalletTxnModelFromJson(String str) =>
    EmployeewalletTxnModel.fromJson(json.decode(str));

String employeewalletTxnModelToJson(EmployeewalletTxnModel data) =>
...
class EmployeewalletTxnModel {
  ...
  factory EmployeewalletTxnModel.fromJson(Map<String, dynamic> json) =>
      EmployeewalletTxnModel(
        status: json["status"],
