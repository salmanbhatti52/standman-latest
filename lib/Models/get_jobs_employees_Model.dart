...
//
//     final getJobsEmployeesModel = getJobsEmployeesModelFromJson(jsonString);

import 'dart:convert';

GetJobsEmployeesModel getJobsEmployeesModelFromJson(String str) =>
    GetJobsEmployeesModel.fromJson(json.decode(str));

String getJobsEmployeesModelToJson(GetJobsEmployeesModel data) =>
...
class GetJobsEmployeesModel {
  ...
  factory GetJobsEmployeesModel.fromJson(Map<String, dynamic> json) =>
      GetJobsEmployeesModel(
        status: json["status"],
        data: json["data"] != null
