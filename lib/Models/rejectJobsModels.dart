...
//
//     final rejectJobModels = rejectJobModelsFromJson(jsonString);

import 'dart:convert';

RejectJobModels rejectJobModelsFromJson(String str) =>
    RejectJobModels.fromJson(json.decode(str));

String rejectJobModelsToJson(RejectJobModels data) =>
    json.encode(data.toJson());

class RejectJobModels {
  String? status;
  String? message;
  Data? data;
  ...
  factory RejectJobModels.fromJson(Map<String, dynamic> json) =>
      RejectJobModels(
        status: json["status"],
