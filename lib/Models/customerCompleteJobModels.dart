...
//
//     final customerJobsCompleteModels = customerJobsCompleteModelsFromJson(jsonString);

import 'dart:convert';

CustomerJobsCompleteModels customerJobsCompleteModelsFromJson(String str) =>
    CustomerJobsCompleteModels.fromJson(json.decode(str));

String customerJobsCompleteModelsToJson(CustomerJobsCompleteModels data) =>
    json.encode(data.toJson());

class CustomerJobsCompleteModels {
  String? status;
  Data? data;
  ...
  factory CustomerJobsCompleteModels.fromJson(Map<String, dynamic> json) =>
      CustomerJobsCompleteModels(
        status: json["status"],
