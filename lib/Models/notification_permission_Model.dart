...
//
//     final notificationPermissionModel = notificationPermissionModelFromJson(jsonString);

import 'dart:convert';

NotificationPermissionModel notificationPermissionModelFromJson(String str) =>
    NotificationPermissionModel.fromJson(json.decode(str));

String notificationPermissionModelToJson(NotificationPermissionModel data) =>
