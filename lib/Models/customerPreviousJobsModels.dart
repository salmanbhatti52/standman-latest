...
//
//     final customerPreviousJobsModels = customerPreviousJobsModelsFromJson(jsonString);

import 'dart:convert';

CustomerPreviousJobsModels customerPreviousJobsModelsFromJson(String str) =>
    CustomerPreviousJobsModels.fromJson(json.decode(str));

String customerPreviousJobsModelsToJson(CustomerPreviousJobsModels data) =>
    json.encode(data.toJson());

class CustomerPreviousJobsModels {
  String? status;
  List<Datum>? data;

  CustomerPreviousJobsModels({
    this.status,
    this.data,
  });

  factory CustomerPreviousJobsModels.fromJson(Map<String, dynamic> json) =>
      CustomerPreviousJobsModels(
        status: json["status"],
