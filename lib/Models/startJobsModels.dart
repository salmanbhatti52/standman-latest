...
//
//     final startJobJobModels = startJobJobModelsFromJson(jsonString);

import 'dart:convert';

StartJobJobModels startJobJobModelsFromJson(String str) =>
    StartJobJobModels.fromJson(json.decode(str));

String startJobJobModelsToJson(StartJobJobModels data) =>
    json.encode(data.toJson());

class StartJobJobModels {
  String? status;
  String? message;
  Data? data;
  ...
  factory StartJobJobModels.fromJson(Map<String, dynamic> json) =>
      StartJobJobModels(
        status: json["status"],
