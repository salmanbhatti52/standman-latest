...
//
//     final jobsCreateDiscountModel = jobsCreateDiscountModelFromJson(jsonString);

import 'dart:convert';

JobsCreateDiscountModel jobsCreateDiscountModelFromJson(String str) => JobsCreateDiscountModel.fromJson(json.decode(str));

String jobsCreateDiscountModelToJson(JobsCreateDiscountModel data) => json.encode(data.toJson());

class JobsCreateDiscountModel {
    String? status;
    Data? data;

    JobsCreateDiscountModel({
         this.status,
         this.data,
    });

    factory JobsCreateDiscountModel.fromJson(Map<String, dynamic> json) => JobsCreateDiscountModel(
        status: json["status"],
