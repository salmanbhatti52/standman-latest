...
//
//     final createJobByStripeDiscount = createJobByStripeDiscountFromJson(jsonString);

import 'dart:convert';

CreateJobByStripeDiscount createJobByStripeDiscountFromJson(String str) =>
    CreateJobByStripeDiscount.fromJson(json.decode(str));

String createJobByStripeDiscountToJson(CreateJobByStripeDiscount data) =>
    json.encode(data.toJson());

class CreateJobByStripeDiscount {
  String? status;
  String? message;
  Data? data;
  ...
  factory CreateJobByStripeDiscount.fromJson(Map<String, dynamic> json) =>
      CreateJobByStripeDiscount(
        status: json["status"],
