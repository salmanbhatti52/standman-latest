...
//
//     final updateProfileCustomerModel = updateProfileCustomerModelFromJson(jsonString);

import 'dart:convert';

UpdateProfileCustomerModel updateProfileCustomerModelFromJson(String str) =>
    UpdateProfileCustomerModel.fromJson(json.decode(str));

String updateProfileCustomerModelToJson(UpdateProfileCustomerModel data) =>
...
class UpdateProfileCustomerModel {
  ...
  factory UpdateProfileCustomerModel.fromJson(Map<String, dynamic> json) =>
      UpdateProfileCustomerModel(
        status: json["status"],
