...
//
//     final acceptJobModels = acceptJobModelsFromJson(jsonString);

import 'dart:convert';

AcceptJobModels acceptJobModelsFromJson(String str) =>
    AcceptJobModels.fromJson(json.decode(str));

String acceptJobModelsToJson(AcceptJobModels data) =>
    json.encode(data.toJson());

class AcceptJobModels {
  String? status;
  String? message;
  Data? data;
  ...
  factory AcceptJobModels.fromJson(Map<String, dynamic> json) =>
      AcceptJobModels(
        status: json["status"],
