...
class _CustomerInboxState extends State<CustomerInbox> {
  ...
  allmessages() async {
    ...
    final responseString = response.body;
    print("Ibox: $responseString");
    print("status Code inbox: ${response.statusCode}");
    print("in 200 Update");
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final imagemessage =
                    getMessageModel.data![revers].messageType == "attachment";
                ...
                DateTime inputTime = getMessageModel.data![revers].dateAdded;
                DateTime inputDate = getMessageModel.data![revers].dateAdded;
