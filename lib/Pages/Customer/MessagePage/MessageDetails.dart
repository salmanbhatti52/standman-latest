  ...
  sendMessageApiWidget() async {
    ...
    if (jsonData['message'] == 'Message sent successfully.') {
      final response = await sendNotification(
          ["${oneSignalID}"], "Customer send a message", "StandMan");
                            ...
                            children: [
                              ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  int reverseIndex =
                                      getMessageModel.data!.length - 1 - index;
                                                            ...
                                                            ? Container(
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      // "time",
                                                                      "${getMessageModel.data?[reverseIndex].dateAdded} ",
                                                                      overflow:
                                                                          TextOverflow
                                                                              .ellipsis,
                                                                      textAlign:
                                                                    ...
                                                                    ClipRRect(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        height:
                                                                            110,
                                                                        image: NetworkImage(
                                                                            "$baseUrlImage${getMessageModel.data?[reverseIndex].message}"),
                                                                      ),
                                                                    ),
                                                                    Padding(
