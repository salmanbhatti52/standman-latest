...
import '../../../Models/search_employeeJobs_Model.dart';
import '../../../Utils/api_urls.dart';
import '../../Customer/HomePage/HomePage.dart';
import 'package:http/http.dart' as http;

class EmpSearchJobs extends StatefulWidget {
  const EmpSearchJobs({Key? key}) : super(key: key);

  @override
  State<EmpSearchJobs> createState() => _EmpSearchJobsState();
}

class _EmpSearchJobsState extends State<EmpSearchJobs> {
  var searchController = TextEditingController();
  SearchEmployeeJobsModel searchEmployeeJobsModel = SearchEmployeeJobsModel();
  bool loading = false;

  searchCarsWidget() async {
    // try {
    String apiUrl = searchJobsEmployeesApiUrl;
    ...
    if (searchController.text.isNotEmpty) {
      ...
      searchEmployeeJobsModel.data?.clear();
          ...
          children: [
            ...
            Container(
              ...
              child: loading
                  ...
                  : searchEmployeeJobsModel.data?.length == null
                      ? Center(
                          child: Text(
                            "No Result",
                            style: TextStyle(
                      ...
                      : Expanded(
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: searchEmployeeJobsModel.data?.length,
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: FadeInImage(
                                            ...
                                            height: 96,
                                            image: NetworkImage(
                                                "$baseUrlImage${searchEmployeeJobsModel.data?[index].image}"),
                                          ),
                                        ),
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                // 'Eleanor Pena',
                                                "${searchEmployeeJobsModel.data?[index].name}",
                                                style: TextStyle(
...
// letterSpacing: -0.3,
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  // 'Mar 03, 2023',
                                                  "${searchEmployeeJobsModel.data?[index].dateAdded}",
                                                  style: TextStyle(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  CircleAvatar(
                                                      ...
                                                      backgroundColor:
                                                          Colors.transparent,
                                                      backgroundImage: searchEmployeeJobsModel
                                                                  .data?[index]
                                                                  .usersCustomersData ==
                                                              null
                                                          ? Image.asset(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Text(
                                                        // 'Wade Warren',
                                                        "${searchEmployeeJobsModel.data?[index].usersCustomersData!.firstName} ${searchEmployeeJobsModel.data?[index].usersCustomersData!.lastName}",
                                        ...
                                        Container(
                                          ...
                                          child: Center(
                                            child: Text(
                                              ...
                                              "${searchEmployeeJobsModel.data?[index].status}",
                                              style: TextStyle(
